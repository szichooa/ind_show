	...
	<div class="content-views">
		<div class="user-list">
			<el-menu
				...
				<el-menu-item index="2" style="padding-left:35px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;border-bottom:1px solid #333;" @click="toLocalDB">本地数据库</el-menu-item>
		...
		<div class="content-view">
			...
			<div class="content-view-bottom">				
				...
				<div class="btn-left-bottom">
					<el-button size="small" @click="showAlertNow" v-if="!showLoaclDB" type="primary">数据分析</el-button>
					<el-button size="small" @click="deleteRow" v-if="!showLoaclDB" type="danger">批量删除</el-button>
				</div>
			</div>
...
import tableShow from "../../common/tableShow1.vue";
	...
	export default{
		...
		methods: {
			toLocalDB(){
				this.$router.push('/localdb')
			},
			changeLocalDataBaseShow(item){
				this.showLoaclDB=true;
				var itemL=item;
